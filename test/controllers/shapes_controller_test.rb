...
class ShapesControllerTest < ActionController::TestCase
  ...
  test "should update shape" do
    patch :update, id: @shape, shape: { image: @shape.image, long_side_dot_num: @shape.long_side_dot_num, long_side_size: @shape.long_side_size, model_name: @shape.model_name, name: @shape.name, short_side_size: @shape.short_side_size }
    assert_redirected_to shape_path(assigns(:shape))
  end
